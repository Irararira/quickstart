...
@DisplayName("Тест метода getTriangleSquare класса TriangleCalculator")
public class TriangleTest {
    ...
    void testGetTriangleSquareWithWrongPositiveSides() {
        double expected = -1;
        assertEquals(expected, TriangleCalculator.getTriangleSquare(1, 20, 40), DELTA);
    }
    ...
    void testGetTriangleSquareWithRightPositiveSides() {
        double expected = 6.0;
        assertEquals(expected, TriangleCalculator.getTriangleSquare(3, 4, 5), DELTA);
    }
    ...
    void testGetTriangleSquareWithZeroSides() {
        double expected = -1;
        assertEquals(expected, TriangleCalculator.getTriangleSquare(0, 0, 0), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneZeroSideAndTwoPositiveSides() {
        double expected = -1;
        assertEquals(expected, TriangleCalculator.getTriangleSquare(3, 0, 5), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneFractionalSideAndTwoPositiveSides() {
        ...
        assertEquals(expected, TriangleCalculator.getTriangleSquare(1.5, 2, 3), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneFractionalSides() {
        ...
        assertEquals(expected, TriangleCalculator.getTriangleSquare(1.5, 2.6, 3.7), DELTA);
    }
}
